...
- [vite-plugin-sri-gen](https://github.com/rbonestell/vite-plugin-sri-gen) - Automatically generate and inject Subresource Integrity hashes for your assets, including lazy loaded chunks, to secure them against tampering.
